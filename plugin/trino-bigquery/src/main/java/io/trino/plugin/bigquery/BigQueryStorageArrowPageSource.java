        ...
        implements ConnectorPageSource
{
            ...
            List<BigQueryColumnHandle> columns)
    {
        ...
        Schema schema = getSchema(split.getSchema());
        ...
        this.bigQueryArrowToPageConverter = new BigQueryArrowToPageConverter(schema, streamBufferAllocator, columns);
    ...
    public Page getNextPage()
    {
        ...
        try (ArrowRecordBatch batch = parse(streamBufferAllocator, response)) {
            bigQueryArrowToPageConverter.convert(batch, pageBuilder);
        }
    ...
    private ArrowRecordBatch parse(BufferAllocator allocator, ReadRowsResponse response)
    {
