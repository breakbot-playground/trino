        ...
        implements ConnectorPageSourceProvider
{
    ...
    {
        return arrowSerializationEnabled ? new BigQueryStorageArrowPageSource(bigQueryReadClientFactory.create(session), maxReadRowsRetries, split, columnHandles) : new BigQueryStorageAvroPageSource(bigQueryReadClientFactory.create(session), maxReadRowsRetries, split, columnHandles);
    }
